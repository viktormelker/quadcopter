#ifndef MPU6050_OWN_H_
#define MPU6050_OWN_H_
...
extern int init_gyro();
extern int MPU6050_write_reg(int reg, uint8_t data);
extern int MPU6050_write(int start, const uint8_t *pData, int size);
extern int MPU6050_read(int start, uint8_t *buffer, int size);
extern void read_sensor_values(uint8_t * outdata);
extern double get_temperature(int16_t intemp);

#endif // MPU6050_OWN_H_